...
from models.common import ConvT, Conv, Bottleneck, SPP, DWConv, Focus, BottleneckCSP, Concat, NMS
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [ConvT, Conv, nn.Conv2d, Bottleneck, SPP, DWConv, MixConv2d, Focus, CrossConv, BottleneckCSP, C3]:
            c1, c2 = ch[f], args[0]
