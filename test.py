...
def test(data,
    ...
    if save_json and len(jdict):
        ...
        try:  # https://github.com/cocodataset/cocoapi/blob/master/PythonAPI/pycocoEvalDemo.ipynb
            ...
            # cocoGt = COCO(glob.glob('../coco/annotations/FMS_*.json')[0])  # initialize COCO ground truth api
            cocoGt = COCO(glob.glob('../coco/annotations/instances_*.json')[0])  # initialize COCO ground truth api
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/coco_person.yaml', help='*.data path')
    parser.add_argument('--batch-size', type=int, default=32, help='size of each image batch')
    parser.add_argument('--img-size', type=int, default=[384,640], help='inference size (pixels)')
